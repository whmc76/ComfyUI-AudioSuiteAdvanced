...
import tempfile
# import whisperx  # 暂时移除whisperx功能
...
class MultiSpeakerSpeechToText:
        ...
        return {
            "required": {
                ...
                "use_whisperx": ("BOOLEAN", {
                    "default": False,  # 暂时禁用whisperx
                    "description": "使用 WhisperX 进行说话人分离（暂时禁用）"
                }),
                "auth_token": ("STRING", {
                    "default": "",
    ...
    def execute(self, audio: Dict[str, Any], language: str, whisper_model: str, use_whisperx: bool, auth_token: str):
        ...
        try:
            if use_whisperx:
                # 暂时禁用whisperx功能
                print("[WARNING] WhisperX功能暂时禁用，使用pyannote替代")
